 ...
 * @internal
 */
final class CmssectionServiceTest extends CIUnitTestCase
{
    public function testIndexContractReturnsDataTransferObjectInterface(): void
    {
        $method = new ReflectionMethod(CmssectionService::class, 'index');
    ...
    {
        $store = new ReflectionMethod(CmssectionService::class, 'store');
        $update = new ReflectionMethod(CmssectionService::class, 'update');
